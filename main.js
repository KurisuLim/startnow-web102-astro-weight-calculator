...
var planets = [
  ...
  function handleClickEvent(e) {
    ...
    totalWeight = calculateWeight(userWeight, gravity); //gets the total weight

    result = 'If you were on ' + planetName+', you would weigh ' + totalWeight +'lbs!';
